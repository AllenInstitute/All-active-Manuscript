...
hof_param_spiny = hof_param_type_df.loc[hof_param_type_df.Dendrite_type ==
                                        'spiny', hof_param_fields]
num_spiny_cells = int(hof_param_spiny.shape[0]/40)
hof_param_aspiny = hof_param_type_df.loc[hof_param_type_df.Dendrite_type ==
                                         'aspiny', hof_param_fields]
